...
export const TABS = ['ACCOUNTING', 'PPC', 'SEO', 'REIMBURSEMENT', 'CASES', 'ACTIONS', 'HISTORY', 'AUTOMATION', 'SERVICES', 'SETTINGS'];
...
export function setWorkspaceQuery(state,id,value) {
  if(id==='settings'||!TABS.some(tab=>tab.toLowerCase()===id))return false;
